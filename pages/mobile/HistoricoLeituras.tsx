                      ...
                      >
                        ...
                        <div className="text-xs text-slate-500 space-y-0.5">
                          <div className="flex justify-between">
                            <span>Entrada: R$ {(venda.totalEntrada || 0).toFixed(2)}</span>
                            <span>Saída: R$ {(venda.totalSaida || 0).toFixed(2)}</span>
                          </div>
                          {((venda as any).despesa > 0 || (venda as any).valorComissao > 0) && (
                            <div className="flex justify-between text-orange-600">
                              {(venda as any).despesa > 0 && (
                                <span>Desp: -R$ {((venda as any).despesa || 0).toFixed(2)}</span>
                              )}
                              {(venda as any).valorComissao > 0 && (
                                <span>Com: -R$ {((venda as any).valorComissao || 0).toFixed(2)}</span>
                              )}
                            </div>
                          )}
                        </div>
